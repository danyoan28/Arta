...
ki10 = ARTA.LINE() #bot10
ki10.login(token='')
ki10.loginResult()

ki11 = ARTA.LINE() #bot11
ki11.login(token='')
ki11.loginResult()

ki12 = ARTA.LINE() #bot12
ki12.login(token='')
ki12.loginResult()

ki13 = ARTA.LINE() #bot13
ki13.login(token='')
ki13.loginResult()

ki14 = ARTA.LINE() #bot14
ki14.login(token='')
ki14.loginResult()

ki15 = ARTA.LINE() #bot15
ki15.login(token='')
ki15.loginResult()

ki16 = ARTA.LINE() #bot16
ki16.login(token='')
ki16.loginResult()

ki17 = ARTA.LINE() #bot17
ki17.login(token='')
ki17.loginResult()

ki18 = ARTA.LINE() #bot18
ki18.login(token='')
ki18.loginResult()

ki19 = ARTA.LINE() #bot19
ki19.login(token='')
ki19.loginResult()

ki20 = ARTA.LINE() #bot20
ki20.login(token='')
ki20.loginResult()
...
admsa = "ue4e06387a5cae9fdf8cd018a41b35e98"
admin = "ue4e06387a5cae9fdf8cd018a41b35e98"
creator = "ue4e06387a5cae9fdf8cd018a41b35e98"
...
#------------------------------                        
                ...
                cl.sendText(msg.to,"􂤁􀆋☞This Is My Creator")
                cl.sendMessage(msg)
...
#-----------------------------------------------------------
				...
				OWN = "ue4e06387a5cae9fdf8cd018a41b35e98"
				if msg.from_ in OWN:
					pass
				else:
