...
helpMessage ="""╔═════════════
║𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓
║       ✰A̸͟͞R̸͟͞T̸͟͞A̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞I̸͟͞O̸͟͞N̸͟͞✰
║𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓
║╔════════════
║╠[1]Status
║╠[2]Bot?
...
║╠[34]Ready op
║╠[35]Runtime
║╠[36]Team1/2/3/4/5 Buka qr
║╠[37]Team1/2/3/4/5 Close qr
║╠[38]Protect out
║╠[39]Mode on/off
║╠[40]Protect on/off
║╠[41]Admin add @
...
admin = ["ued156c86ffa56024c0acba16f7889e6d",mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            elif "Team1 kick " in msg.text:
                midd = msg.text.replace("Bot1 kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "Team2 kick " in msg.text:
              #if msg.from_ in admin:
            ...
            elif "Team1 invite " in msg.text:
              #if msg.from_ in admin:
                midd = msg.text.replace("Bot1 invite ","")
                ki.findAndAddContactsByMid(midd)
                ki.inviteIntoGroup(msg.to,[midd])
            elif "Team2 invite " in msg.text:
              #if msg.from_ in admin:
    ...
    #--------------- SC Add Admin ---------
              ...
              if admin == []:
                  ...
                  mc = "||Admin A̸͟͞R̸͟͞T̸͟͞A̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞I̸͟͞O̸͟͞N̸͟͞||\n=====================\n"
                  for mi_d in admin:
    ...
    #-----------------=Selesai=------------------
              ...
              ##if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Team1 buka qr","Team1 open qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done Senpai")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Team2 buka qr","Team2 open qr"]:
                if msg.toType == 2:
                    X = ki2.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki2.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki2.sendText(msg.to,"Done Senpai")
                    else:
		...
		for ticket_id in n_links:
            ...
            elif msg.text in ["Team1 rename "]:
              #if msg.from_ in admin:
                string = msg.text.replace("Team1 rename ","")
                if len(string.decode('utf-8')) <= 20:
                    profile = ki.getProfile()
                    profile.displayName = string
                    ki.updateProfile(profile)
                    ki.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Team2 rename "]:
              #if msg.from_ in admin:
                string = msg.text.replace("Team2 rename ","")
                if len(string.decode('utf-8')) <= 20:
                    profile_B = ki2.getProfile()
                    profile_B.displayName = string
                    ki2.updateProfile(profile_B)
                    ki2.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Team3 rename "]:
              #if msg.from_ in admin:
                string = msg.text.replace("Team3 rename ","")
                if len(string.decode('utf-8')) <= 20:
                    profile_B = ki3.getProfile()
                    profile_B.displayName = string
                    ki3.updateProfile(profile_B)
                    ki3.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Team4 rename "]:
              #if msg.from_ in admin:
                string = msg.text.replace("Team4 rename ","")
                if len(string.decode('utf-8')) <= 20:
                    profile_B = ki4.getProfile()
                    profile_B.displayName = string
                    ki4.updateProfile(profile_B)
                    ki4.sendText(msg.to,"name " + string + " done")
            elif msg.text in ["Team5 rename "]:
              #if msg.from_ in admin:
                string = msg.text.replace("Team5 rename ","")
                if len(string.decode('utf-8')) <= 20:
...
#---------------------Sc invite owner ke group------
                ...
                van = "Bot Has Been Actived "+waktu(eltime)
        ...
        #-------------Fungsi Jam Update Finish-------------------#
                ...
                #print wait2
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Di Read Oleh||%s\n||By : A̸͟͞R̸͟͞T̸͟͞A̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞I̸͟͞O̸͟͞N̸͟͞||\n\n>Pelaku CCTV<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\nAmiin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
    ...
    #-------------------------------------------------#
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"A̸͟͞R̸͟͞T̸͟͞A̸͟͞ P̸͟͞R̸͟͞O̸͟͞T̸͟͞E̸͟͞C̸͟͞T̸͟͞I̸͟͞O̸͟͞N̸͟͞ Mau Bersih² Group Sampah Nih")
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Protect out","@Bye"]:
              #if msg.from_ in admin:
                gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              #if msg.from_ in admin:
                cl.sendText(msg.to,"Komandan On")
                ki.sendText(msg.to,"Team1 On")
                ki2.sendText(msg.to,"Team2 On")
                ki3.sendText(msg.to,"Team3 On")
                ki4.sendText(msg.to,"Team4 On")
                ki5.sendText(msg.to,"Team5 On")
                cl.sendText(msg.to,"Semua Udah Hadir Boss\nSiap Protect Group\nAman Gak Aman Yang Penting Aman")
