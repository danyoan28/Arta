...
kk = ARTA.LINE()#Assist1
#kk.login(qr=True)
kk.login(token="")
kk.loginResult()

kc = ARTA.LINE()#Assist2
#kc.login(qr=True)
kc.login(token="")
kk.loginResult()
print "===[Login Success]==="
...
admin=["ue4e06387a5cae9fdf8cd018a41b35e98",mid,Amid,Bmid]
...
#--------------------------------------------------------
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"This is My Crearor")
#--------------------------------------------------------
...
#--------------------------------------------------------
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in owner:
                start = time.time()
                cl.sendText(msg.to, "ċǟʟċʊʟǟtɨռɢ.....")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                cl.sendText(msg.to,"Succes BosQ")
            elif msg.text in ["Join all","join all","Join All","join All","Kuy"]: #Panggil Semua Bot
              if msg.from_ in admin:
